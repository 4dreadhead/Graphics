...
class MathHelper:
    # Fast math calculating determinant
    @staticmethod
    @njit(fastmath=True)
    def determinant(matrix_0, matrix_1, matrix_2):
    ...
    # Fast math calculating depth for z-buffer
    @staticmethod
    @njit(fastmath=True)
    ...
    # Prepare and calculate depth for z-buffer
    @staticmethod
    ...
    @staticmethod
    def sort_apexes(triangle, descending=False):
        for _ in range(3):
